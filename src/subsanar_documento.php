...
// Guardar temporal
$tempOriginal = 'uploads/temp/' . uniqid() . '_subsanacion.pdf';
...
// Si falla Ghostscript usar original
if ($returnVar !== 0 || !file_exists($rutaArchivo)) {

    $rutaArchivo = $uploadDir . uniqid() . '_subsanado_original.pdf';

    copy($tempOriginal, $rutaArchivo);
}
